...
public class BrowserHistoryPage extends Fragment
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        Uri.Builder combinedBuilder = BrowserCompat.COMBINED_URI.buildUpon();
        ...
        switch (id) {
            ...
            case LOADER_MOST_VISITED: {
                Uri uri = combinedBuilder
                        .appendQueryParameter(BrowserCompat.PARAM_LIMIT, mMostVisitsLimit)
                        .build();
                String where = Combined.VISITS + " > 0";
    ...
    static class ClearHistoryTask extends Thread {
        ...
        @Override
        public void run() {
            BrowserCompat.clearHistory(mResolver);
        }
    }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_to_bookmarks_menu_id:
                if (historyItem.isBookmark()) {
                    ...
                    BrowserCompat.saveBookmark(activity, title, url);
                }
                return true;
            case R.id.share_link_context_menu_id:
                BrowserCompat.sendString(activity, url,
            ...
            case R.id.delete_context_menu_id:
                BrowserCompat.deleteFromHistory(activity.getContentResolver(), url);
                return true;
