...
public class DownloadHandler {
    ...
    /*package */ static void onDownloadStartNoStream(Activity activity,
        ...
        // Keep Downloads managed by DownloadManager. On modern Android, avoid forcing
        // legacy external-storage paths and let the system manage destination.
        ...
        String cookies = getCookiesForDownload(url, privateBrowsing);
    ...
    private static String getCookiesForDownload(String url, boolean privateBrowsing) {
        CookieManager cookieManager = CookieManager.getInstance();
        try {
            Method method = CookieManager.class.getMethod("getCookie",
                    String.class, boolean.class);
            Object value = method.invoke(cookieManager, url, privateBrowsing);
