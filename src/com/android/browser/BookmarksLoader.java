...
public class BookmarksLoader extends CursorLoader {
    ...
    public BookmarksLoader(Context context, String accountType, String accountName) {
        super(context, addAccount(BrowserCompat.BOOKMARKS_DEFAULT_FOLDER_URI,
    ...
    static Uri addAccount(Uri uri, String accountType, String accountName) {
        ...
        return uri.buildUpon()
                .appendQueryParameter(Bookmarks.PARAM_ACCOUNT_TYPE, accountType)
                .appendQueryParameter(Bookmarks.PARAM_ACCOUNT_NAME, accountName)
                .build();
    }
}
