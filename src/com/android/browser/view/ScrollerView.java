...
public class ScrollerView extends FrameLayout {
    ...
    public ScrollerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, new int[] { android.R.attr.fillViewport }, defStyle, 0);
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                if (!mScroller.isFinished()) {
                    ...
                    if (mFlingStrictSpan != null) {
                        finishCriticalSpan(mFlingStrictSpan);
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mScrollStrictSpan != null) {
            finishCriticalSpan(mScrollStrictSpan);
    ...
    private float getHorizontalScrollFactorCompat() {
        return ViewConfiguration.get(getContext()).getScaledHorizontalScrollFactor();
    }
    ...
    private static Object enterCriticalSpan(String name) {
        try {
            return StrictMode.class.getMethod("enterCriticalSpan", String.class).invoke(null, name);
        } catch (Throwable ignored) {
            return null;
        }
    }

    private static void finishCriticalSpan(Object span) {
        if (span == null) {
            return;
        }
        try {
