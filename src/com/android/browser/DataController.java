...
public class DataController {
    ...
    class DataControllerHandler extends Thread {
        ...
        private void doUpdateVisitedHistory(String url) {
            ...
            Cursor c = null;
            try {
                c = cr.query(BrowserCompat.HISTORY_URI, new String[] { History._ID, History.VISITS },
                ...
                if (c.moveToFirst()) {
                    ...
                    cr.update(ContentUris.withAppendedId(BrowserCompat.HISTORY_URI, c.getLong(0)),
                            values, null, null);
                } else {
                    BrowserCompat.truncateHistory(cr);
                    ContentValues values = new ContentValues();
                    ...
                    cr.insert(BrowserCompat.HISTORY_URI, values);
                }
            } finally {
                if (c != null) c.close();
            }
        ...
        private void doUpdateHistoryTitle(String url, String title) {
            ...
            cr.update(BrowserCompat.HISTORY_URI, values, History.URL + "=?",
                    new String[] { url });
        }
    }
}
