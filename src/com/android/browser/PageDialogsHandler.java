...
public class PageDialogsHandler {
    ...
    private AlertDialog.Builder createSslCertificateDialog(SslCertificate certificate,
        ...
        final LinearLayout placeholder = new LinearLayout(mContext);
        placeholder.setOrientation(LinearLayout.VERTICAL);
        certificateView.addView(placeholder);
        ...
        if (error == null) {
            ...
            LinearLayout table = (LinearLayout)factory.inflate(
                    R.layout.ssl_success, placeholder, false);
            TextView successString = (TextView)table.findViewById(R.id.success);
            successString.setText(R.string.page_info);
            placeholder.addView(table);
        } else {
