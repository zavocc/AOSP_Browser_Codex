...
public class IntentHandler {
    ...
    private static final String APP_DATA_SOURCE_KEY = "source";
    ...
    void onNewIntent(Intent intent) {
        ...
        if (Intent.ACTION_VIEW.equals(action)
            ...
            if (intent.getBooleanExtra(BrowserCompat.EXTRA_CREATE_NEW_TAB, false)
                  || urlData.isPreloaded()) {
            ...
            final String appId = intent
                    .getStringExtra(BrowserCompat.EXTRA_APPLICATION_ID);
            if (Intent.ACTION_VIEW.equals(action)
                    && (appId != null)
            ...
            if (Intent.ACTION_VIEW.equals(action) ||
                ...
                if (url != null && url.startsWith("http")) {
                    final Bundle pairs = intent
                            .getBundleExtra(BrowserCompat.EXTRA_HEADERS);
                ...
                if (url != null) {
                    ...
                    if (url.contains(searchSource)) {
                        ...
                        if (appData != null) {
                            source = appData.getString(APP_DATA_SOURCE_KEY);
                        }
    ...
    private static boolean handleWebSearchRequest(Activity activity,
        ...
        if (controller == null || controller.getTabControl() == null
                ...
                || !WebViewCompatibility.isPrivateBrowsingEnabled(
                        controller.getTabControl().getCurrentWebView())) {
            new AsyncTask<Void, Void, Void>() {
                @Override
                protected Void doInBackground(Void... unused) {
                        BrowserCompat.addSearchUrl(cr, newUrl);
                    return null;
                }
            }.execute();
        }
        ...
        try {
            ...
            Log.w(TAG, "Search provider launch failed", e);
            return false;
        }
