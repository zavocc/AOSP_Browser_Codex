...
import com.android.browser.compat.BrowserCompat;
...
public class Controller
    ...
    public Controller(Activity browser) {
        ...
        browser.getContentResolver().registerContentObserver(
                BrowserCompat.BOOKMARKS_URI, true, mBookmarksObserver);
    ...
    void doStart(final Bundle icicle, final Intent intent) {
        ...
        if (currentTabId == -1) {
            ...
            WebViewCompatibility.removeSessionCookies(CookieManager.getInstance());
        }
    ...
    private void onPreloginFinished(Bundle icicle, Intent intent, long currentTabId,
        ...
        if (currentTabId == -1) {
            ...
            if (intent == null) {
                ...
                if (t != null) {
                    t.setAppId(intent.getStringExtra(BrowserCompat.EXTRA_APPLICATION_ID));
                }
                WebView webView = t.getWebView();
                if (extra != null) {
                    int scale = extra.getInt(BrowserCompat.INITIAL_ZOOM_LEVEL, 0);
    ...
    public void createSubWindow(Tab tab) {
        ...
        WebView subView = mFactory.createWebView((mainView == null)
                ? false
                : WebViewCompatibility.isPrivateBrowsingEnabled(mainView));
                        ...
                        switch (msg.arg1) {
                            ...
                            case R.id.download_context_menu_id:
                                DownloadHandler.onDownloadStartNoStream(
                                        ...
                                        null, null, null,
                                        WebViewCompatibility.isPrivateBrowsingEnabled(view));
                                break;
                        }
                        break;
                    }
    ...
    static final void sharePage(Context c, String title, String url,
        ...
        send.putExtra(BrowserCompat.EXTRA_SHARE_FAVICON, favicon);
        send.putExtra(BrowserCompat.EXTRA_SHARE_SCREENSHOT, screenshot);
        try {
    ...
    public void onPause() {
        ...
        WebViewCompatibility.disablePlatformNotifications();
    ...
    public void onResume() {
        ...
        WebViewCompatibility.enablePlatformNotifications();
    ...
    private boolean pauseWebViewTimers(Tab tab) {
        if (tab == null) {
            ...
            WebViewCompatibility.flushCookies(CookieManager.getInstance());
    ...
    public void getVisitedHistory(final ValueCallback<String[]> callback) {
        AsyncTask<Void, Void, String[]> task =
            ...
            public String[] doInBackground(Void... unused) {
                return BrowserCompat.getVisitedHistory(mActivity.getContentResolver());
            }
            @Override
    ...
    public void onReceivedHttpAuthRequest(Tab tab, WebView view,
        ...
        if (username != null && password != null) {
            ...
            if (tab.inForeground() && !WebViewCompatibility.suppressHttpAuthDialog(handler)) {
    ...
    public void onDownloadStart(Tab tab, String url, String userAgent,
        ...
        DownloadHandler.onDownloadStart(mActivity, url, userAgent,
                ...
                WebViewCompatibility.isPrivateBrowsingEnabled(w));
        ...
        switch (type) {
            ...
            case WebView.HitTestResult.IMAGE_TYPE:
                ...
                menu.findItem(R.id.download_context_menu_id).setOnMenuItemClickListener(
                        new Download(mActivity, extra,
                                WebViewCompatibility.isPrivateBrowsingEnabled(webview),
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.dump_nav_menu_id:
                WebViewCompatibility.debugDump(getCurrentTopWebView());
                break;
    ...
    public void findOnPage() {
        ...
        try {
            if (webView.showFindDialog(null, true)) {
                return;
            }
        } catch (Throwable t) {
            Log.w(LOGTAG, "WebView find dialog unavailable", t);
        }
        final EditText input = new EditText(mActivity);
        input.setHint(R.string.find_on_page_hint);
        input.setSingleLine(true);
        new AlertDialog.Builder(mActivity)
                .setTitle(R.string.find_on_page)
                .setView(input)
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                Log.w(LOGTAG, "Find in page failed", fallbackError);
                                return;
                            }
                        }
                        try {
                            ...
                            Log.w(LOGTAG, "Unable to move to next match", t);
                        }
                    }
                })
                .show();
    ...
    public Intent createBookmarkCurrentPageIntent(boolean editExisting) {
        ...
        String touchIconUrl = WebViewCompatibility.getTouchIconUrl(w);
    ...
    static Bitmap createScreenshot(WebView view, int width, int height) {
        if (view == null || view.getContentHeight() == 0
                || WebViewCompatibility.getContentWidth(view) == 0) {
            return null;
        }
        ...
        int contentWidth = WebViewCompatibility.getContentWidth(view);
